                  ...
                  keyInsights: [
                    {
                      ...
                      relatedTechnologies: ["Computer Vision", "GUI Interaction", "AI Automation", "Screen Interpretation"],
                      visible: false,
                    },
                    {
                      id: "mock-insight-2",
                      ...
                      relatedTechnologies: ["Input Automation", "File Operations", "Command Line Interface", "System Control"],
                      visible: false,
                    },
                  ],
                  ...
                  keyInsights: [
                    {
                      ...
                      relatedTechnologies: ["Beta Features", "Interface Challenges", "Performance Limitations", "User Experience"],
                      visible: false,
                    },
                  ],
