...
const baseNodes: BaseNode[] = [
    ...
    { id: "break5_3", type: "breakthrough", parentId: "cat5", data: { title: "Function Calling API", date: "Mar 2025", color: "green", organization: "OpenAI", summary: "Allows a ChatGPT agent to invoke multiple tools in one prompt for complex actions", source: "https://openai.com", isExpanded: false, details: "This API update effectively let a ChatGPT-based agent juggle multiple tools or functions in one conversation turn. A single agent can act like a coordinator, invoking different APIs (search, calculator, etc.) one after another without human prompts." }, hidden: false },
];
